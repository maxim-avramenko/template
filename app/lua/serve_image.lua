...
--local secret = ngx.var.secret -- signature secret key
local images_dir = ngx.var.images_pwd -- where images come from
--local cache_dir = ngx.var.cache_pwd -- where images are cached
...
ngx.say(magick.thumb(source_fname, size))
